...
/**
 * This is the item provider adapter for a {@link org.eclipse.docker.language.container.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BindingItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHostIPPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Host IP feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHostIPPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_hostIP_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_hostIP_feature", "_UI_Binding_type"),
				 ContainerPackage.Literals.BINDING__HOST_IP,
				 true,
				 false,
				 false,
	...
	protected void addHostPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_hostPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_hostPort_feature", "_UI_Binding_type"),
				 ContainerPackage.Literals.BINDING__HOST_PORT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Binding)object).getHostIP();

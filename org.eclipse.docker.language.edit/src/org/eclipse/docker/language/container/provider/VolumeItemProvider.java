...
/**
 * This is the item provider adapter for a {@link org.eclipse.docker.language.container.Volume} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VolumeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Volume_path_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Volume_path_feature", "_UI_Volume_type"),
				 ContainerPackage.Literals.VOLUME__PATH,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Volume)object).getPath();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Volume.class)) {
			case ContainerPackage.VOLUME__PATH:

...
entryRuleContainerSection returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getContainerSectionRule()); }
	 iv_ruleContainerSection=ruleContainerSection 
	 { $current=$iv_ruleContainerSection.current; } 
	 EOF 
;

// Rule ContainerSection
ruleContainerSection returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleImageSection returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getImageSectionRule()); }
	 iv_ruleImageSection=ruleImageSection 
	 { $current=$iv_ruleImageSection.current; } 
	 EOF 
;

// Rule ImageSection
ruleImageSection returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((

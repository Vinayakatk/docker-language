	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getDockerAccess().getAlternatives(), "rule__Docker__Alternatives");
					...
					put(grammarAccess.getContainerAccess().getGroup_5_34_2(), "rule__Container__Group_5_34_2__0");
					put(grammarAccess.getContainerAccess().getGroup_5_35(), "rule__Container__Group_5_35__0");
					put(grammarAccess.getContainerAccess().getGroup_5_35_2(), "rule__Container__Group_5_35_2__0");
					put(grammarAccess.getContainerAccess().getGroup_5_36(), "rule__Container__Group_5_36__0");
					put(grammarAccess.getContainerAccess().getGroup_5_36_2(), "rule__Container__Group_5_36_2__0");
					...
					put(grammarAccess.getDockerAccess().getContainersAssignment_0(), "rule__Docker__ContainersAssignment_0");
					put(grammarAccess.getDockerAccess().getImagesAssignment_1(), "rule__Docker__ImagesAssignment_1");
					...
					put(grammarAccess.getImageAccess().getDockerFileDirAssignment_3_1_1(), "rule__Image__DockerFileDirAssignment_3_1_1");
					put(grammarAccess.getImageAccess().getBuildargsAssignment_3_2_1(), "rule__Image__BuildargsAssignment_3_2_1");
					...
					put(grammarAccess.getContainerAccess().getCgroupParentAssignment_5_29_1(), "rule__Container__CgroupParentAssignment_5_29_1");
					put(grammarAccess.getContainerAccess().getWorkingDirAssignment_5_30_1(), "rule__Container__WorkingDirAssignment_5_30_1");
					put(grammarAccess.getContainerAccess().getUserAssignment_5_31_1(), "rule__Container__UserAssignment_5_31_1");
					put(grammarAccess.getContainerAccess().getTtyAssignment_5_32_1(), "rule__Container__TtyAssignment_5_32_1");
					put(grammarAccess.getContainerAccess().getRestartPolicyAssignment_5_33_1(), "rule__Container__RestartPolicyAssignment_5_33_1");
					put(grammarAccess.getContainerAccess().getVolumesAssignment_5_34_2_1(), "rule__Container__VolumesAssignment_5_34_2_1");
					put(grammarAccess.getContainerAccess().getVolumesFromAssignment_5_35_2_1(), "rule__Container__VolumesFromAssignment_5_35_2_1");
					put(grammarAccess.getContainerAccess().getUlimitsAssignment_5_36_2_1(), "rule__Container__UlimitsAssignment_5_36_2_1");
					put(grammarAccess.getVolumesFromAccess().getContainerAssignment_1(), "rule__VolumesFrom__ContainerAssignment_1");
					put(grammarAccess.getVolumesFromAccess().getAccessModeAssignment_2(), "rule__VolumesFrom__AccessModeAssignment_2");
					put(grammarAccess.getRestartPolicyAccess().getNameAssignment_1(), "rule__RestartPolicy__NameAssignment_1");
					put(grammarAccess.getRestartPolicyAccess().getMaximumRetryCountAssignment_2(), "rule__RestartPolicy__MaximumRetryCountAssignment_2");
					...
					put(grammarAccess.getLinkAccess().getAliasAssignment_3(), "rule__Link__AliasAssignment_3");
					...
					put(grammarAccess.getBindAccess().getAccessMode1Assignment_5(), "rule__Bind__AccessMode1Assignment_5");
